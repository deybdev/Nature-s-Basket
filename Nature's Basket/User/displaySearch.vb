...
Public Class displaySearch
    ...
    Public Sub New(keyword As String)
        ...
        ' Assign the searchKeyword
        Me.searchKeyword = keyword

        Label5.Text = $"{searchKeyword}"

        ' Load the search results
        LoadProductsBySearch(searchKeyword)
    End Sub


    Private Sub LoadProductsBySearch(searchKeyword As String)

        isLoggedIn = login.isLoggedIn

        loginText.Visible = Not isLoggedIn



        Dim query As String = "SELECT id, name, price, quantity, image, supplier, unit 
                   FROM products 
                   WHERE name LIKE @SearchKeyword OR supplier LIKE @SearchKeyword"
        ...
        Using connection As MySqlConnection = dbConnection.GetDatabaseConnection()
            ...
            Try
                ...
                For Each row As DataRow In dt.Rows
                    ...
                    ' Add the rest of the controls (quantity, buttons) here as in your original code...
